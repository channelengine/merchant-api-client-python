...
class ListedProductsApi(object):
    ...
    def listed_product_get_by_filter(self, channel_id, **kwargs):  # noqa: E501
        ...
        :rtype: CollectionOfChannelListedProductResponse
        """
    ...
    def listed_product_get_by_filter_with_http_info(self, channel_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('channel_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `channel_id` when calling `listed_product_get_by_filter`")  # noqa: E501
