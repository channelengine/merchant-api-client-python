    ...
    def __init__(self, api_client=None):
        ...
        def __offer_stock_price_update(
            ...
            **kwargs
            ...
            Keyword Args:
                merchant_stock_price_update_request ([MerchantStockPriceUpdateRequest], none_type): References to the products that should be updated, and the new values<br />for the stock or price fields. It is possible to supply only one of the two fields<br />or both.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.offer_stock_price_update = _Endpoint(
            ...
            root_map={
                ...
                'openapi_types': {
                    'merchant_stock_price_update_request':
                        ([MerchantStockPriceUpdateRequest], none_type,),
                },
                'attribute_map': {
                },
                'location_map': {
