...
class StockLocationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.stock_location_create_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'stock_location_create',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'merchant_stock_location_create_request',
                ],
                'required': [],
                'nullable': [
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'merchant_stock_location_create_request': 'body',
                },
        ...
        self.stock_location_index_endpoint = _Endpoint(
            settings={
    ...
    def stock_location_create(
        ...
        **kwargs
        ...
        """stock_location_create  # noqa: E501
        ...
        Keyword Args:
            merchant_stock_location_create_request (MerchantStockLocationCreateRequest): [optional]
        ...
        return self.stock_location_create_endpoint.call_with_http_info(**kwargs)

    def stock_location_index(
        self,
        **kwargs
    ):
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.stock_location_index_endpoint.call_with_http_info(**kwargs)
