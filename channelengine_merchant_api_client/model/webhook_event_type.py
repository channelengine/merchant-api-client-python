...
class WebhookEventType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["ORDERS_CREATE", "PRODUCTS_CHANGE", "RETURNS_CHANGE", "SHIPMENTS_CHANGE", "NOTIFICATIONS_CREATE", "BUNDLE_PRODUCTS_CHANGE", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["ORDERS_CREATE", "PRODUCTS_CHANGE", "RETURNS_CHANGE", "SHIPMENTS_CHANGE", "NOTIFICATIONS_CREATE", "BUNDLE_PRODUCTS_CHANGE", ]  # noqa: E501
