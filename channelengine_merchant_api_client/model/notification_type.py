...
class NotificationType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["CHANNEL_ORDER_ANONYMIZED_BY_REQUEST", "CHANNEL_ORDER_ANONYMIZED_AUTOMATICALLY", "CHANNEL_ORDER_CANCELLATION_REQUEST_NEW", "CHANNEL_ORDER_CORRECTION_NEEDED", "CHANNEL_ORDER_DUPLICATE_LINE", "CHANNEL_ORDER_INVOICE_SEND_FAILED", "CHANNEL_ORDER_IMPORT_FAILED", "CHANNEL_ORDER_NEW", "CHANNEL_ORDER_OVERDUE", "CHANNEL_PRODUCT_DATA_EXPORT_FAILED", "CHANNEL_PRODUCT_DATA_IMPORT_FAILED", "CHANNEL_RETURN_EXPORT_FAILED", "CHANNEL_RETURN_IMPORT_FAILED", "CHANNEL_RETURN_NEW", "CHANNEL_RETURN_OVERDUE", "CHANNEL_REFUND_EXPORT_FAILED", "CHANNEL_SHIPMENT_IMPORT_FAILED", "CHANNEL_SHIPMENT_IMPORT_STATUS_FAILED", "CHANNEL_SHIPMENT_EXPORT_FAILED", "CHANNEL_SHIPMENT_IMPORT_MISSING_LINE_FAILED", "CHANNEL_FULFILLMENT_SHIPMENT_IMPORT_STATUS_FAILED", "CHANNEL_FULFILLMENT_SHIPMENT_EXPORT_FAILED", "CHANNEL_FULFILLMENT_SHIPMENT_EXPORT_SUCCEEDED", "CHANNEL_FULFILLMENT_SHIPMENT_LINE_FOR_CLOSED_ORDER", "CHANNELENGINE_SUPPORT_NOTIFICATION", "CHANNELENGINE_WEBHOOK_RQUEST_FAILED", "FEED_NO_PRODUCTS_FAILED", "FEED_IMPORT_FAILED", "GLOBAL_MESSAGE", "MERCHANT_ORDER_EXPORT_FAILED", "PLUGIN_INVALID_SETTING", "PLUGIN_DEACTIVATED", "PRODUCT_BUNDLE_IMPORT_FAILED", "CHANNEL_REFUND_LINE_ITEMS_ERROR", "CHANNEL_CANCELLATION_EXPORT_FAILED", "MERCHANT_ORDER_EXPORT_LINES_CANCELLED", "OAUTH_REFRESH_TOKEN_EXPIRATION", "MERCHANT_CANCELLATION_IMPORT_FAILED", "CHANNEL_ORDER_TOO_LONG_ON_NEW", "MERCHANT_STOCK_UPDATE_FAILED", "FEED_INVALID_PRODUCTS_OCCURED", "CHANNEL_SHIPMENT_EXPORT_INVALID_MERCHANTSHIPMENTNO", "CHANNEL_PRODUCT_OFFER_EXPORT_FAILED", "TRANSLATION_IMAGE_TAGS_BROKEN", "CHANNEL_RETURN_DELETED", "TAX_PROVIDER_NOT_ACTIVATED", "STOCK_LOCATION_NOT_FOUND", "CUSTOM_VAT_RATE_OVERLAPPING_RATES", "TRANSLATION_FAILED", "ORDER_CANNOT_BE_FULFILLED", ]  # noqa: E501
