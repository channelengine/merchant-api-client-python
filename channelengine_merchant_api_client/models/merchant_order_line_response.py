...
class MerchantOrderLineResponse(object):
    ...
    def __init__(self, status=None, is_fulfillment_by_marketplace=None, merchant_product_no=None, unit_vat=None, line_total_incl_vat=None, line_vat=None, original_unit_price_incl_vat=None, original_unit_vat=None, original_line_total_incl_vat=None, original_line_vat=None, channel_product_no=None, quantity=None, unit_price_incl_vat=None, fee_fixed=None, fee_rate=None, condition=None):  # noqa: E501
    ...
    def original_unit_price_incl_vat(self):
        ...
        The value of a single unit of the ordered product including VAT  (in the currency in which the order was paid for).  # noqa: E501
    ...
    def original_unit_vat(self):
        ...
        The total amount of VAT charged over the value of a single unit of the ordered product  (in the currency in which the order was paid for).  # noqa: E501
    ...
    def original_line_total_incl_vat(self):
        ...
        The total value of the order line (quantity * unit price) including VAT  (in the currency in which the order was paid for).  # noqa: E501
    ...
    def original_line_vat(self):
        ...
        The total amount of VAT charged over the total value of the order line (quantity * unit price)  (in the currency in which the order was paid for).  # noqa: E501
