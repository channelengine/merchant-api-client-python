...
class MerchantOrderResponse(object):
    ...
    def original_sub_total_incl_vat(self):
        ...
        The total value of the order lines including VAT  (in the currency in which the order was paid for).  # noqa: E501
    ...
    def original_sub_total_vat(self):
        ...
        The total amount of VAT charged over the order lines  (in the currency in which the order was paid for).  # noqa: E501
    ...
    def original_shipping_costs_incl_vat(self):
        ...
        The shipping fee including VAT  (in the currency in which the order was paid for).  # noqa: E501
    ...
    def original_shipping_costs_vat(self):
        ...
        The total amount of VAT charged over the shipping fee  (in the currency in which the order was paid for).  # noqa: E501
    ...
    def original_total_incl_vat(self):
        ...
        The total value of the order including VAT  (in the currency in which the order was paid for).  # noqa: E501
    ...
    def original_total_vat(self):
        ...
        The total amount of VAT charged over the total value of te order  (in the currency in which the order was paid for).  # noqa: E501
