...
class MerchantReturnRequest(object):
    ...
    def __init__(self, merchant_order_no=None, merchant_return_no=None, lines=None, id=None, reason=None, customer_comment=None, merchant_comment=None, refund_incl_vat=None, refund_excl_vat=None, local_vars_configuration=None):  # noqa: E501
    ...
    def merchant_return_no(self, merchant_return_no):
        ...
        """
        if self.local_vars_configuration.client_side_validation and merchant_return_no is None:  # noqa: E501
            raise ValueError("Invalid value for `merchant_return_no`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                merchant_return_no is not None and len(merchant_return_no) > 50):
            raise ValueError("Invalid value for `merchant_return_no`, length must be less than or equal to `50`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                merchant_return_no is not None and len(merchant_return_no) < 0):
            raise ValueError("Invalid value for `merchant_return_no`, length must be greater than or equal to `0`")  # noqa: E501

        self._merchant_return_no = merchant_return_no

    @property
    def lines(self):
        """Gets the lines of this MerchantReturnRequest.  # noqa: E501


        :return: The lines of this MerchantReturnRequest.  # noqa: E501
    ...
    def lines(self, lines):
        ...
        :param lines: The lines of this MerchantReturnRequest.  # noqa: E501
        :type lines: list[MerchantReturnLineRequest]
        """
