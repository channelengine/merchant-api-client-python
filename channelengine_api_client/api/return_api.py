...
class ReturnApi(object):
    ...
    def return_declare_for_channel(self, model, **kwargs):  # noqa: E501
        """Channel: Create Return  # noqa: E501

        For channels.                Mark (part of) an order as returned by the customer.  # noqa: E501
    ...
    def return_declare_for_merchant(self, model, **kwargs):  # noqa: E501
        """Merchant: Create Return  # noqa: E501

        For merchants.    Mark (part of) an order as returned by the customer.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def return_get_declared_by_channel(self, created_since, **kwargs):  # noqa: E501
        """Merchant: Get Returns  # noqa: E501

        For merchants.    Get all returns created by the channel. This call is supposed  to be used by merchants. Channels should use the 'GET /v2/returns/channel'  call.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def return_get_declared_by_merchant(self, created_since, **kwargs):  # noqa: E501
        """Channel: Get Returns  # noqa: E501

        For channels.                Get all returns created by the merchant. This call is supposed  to be used by channels. Merchants should use the 'GET /v2/returns/merchant'  call.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
