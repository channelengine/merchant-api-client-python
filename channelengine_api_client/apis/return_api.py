...
class ReturnApi(object):
    ...
    def return_declare_for_channel_with_http_info(self, model, **kwargs):
        ...
        return self.api_client.call_api('/v2/returns/channel', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def return_declare_for_merchant_with_http_info(self, model, **kwargs):
        ...
        return self.api_client.call_api('/v2/returns/merchant', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def return_get_declared_by_channel_with_http_info(self, created_since, **kwargs):
        ...
        return self.api_client.call_api('/v2/returns/merchant', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def return_get_declared_by_merchant_with_http_info(self, created_since, **kwargs):
        ...
        return self.api_client.call_api('/v2/returns/channel', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
