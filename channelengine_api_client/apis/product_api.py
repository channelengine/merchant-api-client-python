...
class ProductApi(object):
    ...
    def product_acknowledge_data_changes_with_http_info(self, changes, **kwargs):
        ...
        return self.api_client.call_api('/v2/products/data', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def product_acknowledge_offer_changes_with_http_info(self, changes, **kwargs):
        ...
        return self.api_client.call_api('/v2/products/offers', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def product_create_with_http_info(self, products, **kwargs):
        ...
        return self.api_client.call_api('/v2/products', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def product_delete_with_http_info(self, merchant_product_no, **kwargs):
        ...
        return self.api_client.call_api('/v2/products/{merchantProductNo}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def product_get_by_merchant_product_no_with_http_info(self, merchant_product_no, **kwargs):
        ...
        return self.api_client.call_api('/v2/products/merchant/{merchantProductNo}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def product_get_data_changes_with_http_info(self, **kwargs):
        ...
        if 'max_count' in params:
            query_params.append(('maxCount', params['max_count']))
        ...
        return self.api_client.call_api('/v2/products/data', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def product_get_offer_changes_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/v2/products/offers', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
