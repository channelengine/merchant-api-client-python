...
class ChannelReturnRequest(object):
    ...
    def __init__(self, channel_order_no=None, channel_reference=None, lines=None, reason=None, customer_comment=None, merchant_comment=None, refund_incl_vat=None, refund_excl_vat=None):
        """
        ChannelReturnRequest - a model defined in Swagger
        """
    ...
    def channel_order_no(self):
        """
        Gets the channel_order_no of this ChannelReturnRequest.

        :return: The channel_order_no of this ChannelReturnRequest.
        :rtype: str
        """
    ...
    def channel_order_no(self, channel_order_no):
        ...
        :param channel_order_no: The channel_order_no of this ChannelReturnRequest.
        :type: str
        """
    ...
    def channel_reference(self):
        """
        Gets the channel_reference of this ChannelReturnRequest.

        :return: The channel_reference of this ChannelReturnRequest.
        :rtype: str
        """
    ...
    def channel_reference(self, channel_reference):
        ...
        :param channel_reference: The channel_reference of this ChannelReturnRequest.
        :type: str
        """
        if channel_reference is None:
            raise ValueError("Invalid value for `channel_reference`, must not be `None`")
    ...
    def lines(self):
        """
        Gets the lines of this ChannelReturnRequest.

        :return: The lines of this ChannelReturnRequest.
    ...
    def lines(self, lines):
        ...
        :param lines: The lines of this ChannelReturnRequest.
    ...
    def reason(self):
        """
        Gets the reason of this ChannelReturnRequest.

        :return: The reason of this ChannelReturnRequest.
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        ...
        :param reason: The reason of this ChannelReturnRequest.
        :type: str
        """
    ...
    def customer_comment(self):
        """
        Gets the customer_comment of this ChannelReturnRequest.

        :return: The customer_comment of this ChannelReturnRequest.
        :rtype: str
        """
    ...
    def customer_comment(self, customer_comment):
        ...
        :param customer_comment: The customer_comment of this ChannelReturnRequest.
        :type: str
        """
    ...
    def merchant_comment(self):
        """
        Gets the merchant_comment of this ChannelReturnRequest.

        :return: The merchant_comment of this ChannelReturnRequest.
        :rtype: str
        """
    ...
    def merchant_comment(self, merchant_comment):
        ...
        :param merchant_comment: The merchant_comment of this ChannelReturnRequest.
        :type: str
        """
    ...
    def refund_incl_vat(self):
        """
        Gets the refund_incl_vat of this ChannelReturnRequest.

        :return: The refund_incl_vat of this ChannelReturnRequest.
        :rtype: float
        """
    ...
    def refund_incl_vat(self, refund_incl_vat):
        ...
        :param refund_incl_vat: The refund_incl_vat of this ChannelReturnRequest.
        :type: float
        """
    ...
    def refund_excl_vat(self):
        """
        Gets the refund_excl_vat of this ChannelReturnRequest.

        :return: The refund_excl_vat of this ChannelReturnRequest.
        :rtype: float
        """
    ...
    def refund_excl_vat(self, refund_excl_vat):
        ...
        :param refund_excl_vat: The refund_excl_vat of this ChannelReturnRequest.
        :type: float
        """
