...
class MerchantReturnRequest(object):
    """
    ...
    swagger_types = {
        ...
        'lines': 'list[MerchantReturnLineRequest]',
        'reason': 'str',
    ...
    def __init__(self, merchant_order_no=None, merchant_return_no=None, lines=None, reason=None, customer_comment=None, merchant_comment=None, refund_incl_vat=None, refund_excl_vat=None):
        """
        MerchantReturnRequest - a model defined in Swagger
        """
    ...
    def merchant_order_no(self):
        """
        Gets the merchant_order_no of this MerchantReturnRequest.

        :return: The merchant_order_no of this MerchantReturnRequest.
        :rtype: str
        """
    ...
    def merchant_order_no(self, merchant_order_no):
        ...
        :param merchant_order_no: The merchant_order_no of this MerchantReturnRequest.
        :type: str
        """
    ...
    def merchant_return_no(self):
        """
        Gets the merchant_return_no of this MerchantReturnRequest.

        :return: The merchant_return_no of this MerchantReturnRequest.
        :rtype: str
        """
    ...
    def merchant_return_no(self, merchant_return_no):
        ...
        :param merchant_return_no: The merchant_return_no of this MerchantReturnRequest.
        :type: str
        """
        if merchant_return_no is None:
            raise ValueError("Invalid value for `merchant_return_no`, must not be `None`")
    ...
    def lines(self):
        """
        Gets the lines of this MerchantReturnRequest.

        :return: The lines of this MerchantReturnRequest.
        :rtype: list[MerchantReturnLineRequest]
        """
        return self._lines
    ...
    def lines(self, lines):
        """
        Sets the lines of this MerchantReturnRequest.

        :param lines: The lines of this MerchantReturnRequest.
        :type: list[MerchantReturnLineRequest]
        """
        if lines is None:
    ...
    def reason(self):
        """
        Gets the reason of this MerchantReturnRequest.

        :return: The reason of this MerchantReturnRequest.
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        ...
        :param reason: The reason of this MerchantReturnRequest.
        :type: str
        """
    ...
    def customer_comment(self):
        """
        Gets the customer_comment of this MerchantReturnRequest.

        :return: The customer_comment of this MerchantReturnRequest.
        :rtype: str
        """
    ...
    def customer_comment(self, customer_comment):
        ...
        :param customer_comment: The customer_comment of this MerchantReturnRequest.
        :type: str
        """
    ...
    def merchant_comment(self):
        """
        Gets the merchant_comment of this MerchantReturnRequest.

        :return: The merchant_comment of this MerchantReturnRequest.
        :rtype: str
        """
    ...
    def merchant_comment(self, merchant_comment):
        ...
        :param merchant_comment: The merchant_comment of this MerchantReturnRequest.
        :type: str
        """
    ...
    def refund_incl_vat(self):
        """
        Gets the refund_incl_vat of this MerchantReturnRequest.

        :return: The refund_incl_vat of this MerchantReturnRequest.
        :rtype: float
        """
    ...
    def refund_incl_vat(self, refund_incl_vat):
        ...
        :param refund_incl_vat: The refund_incl_vat of this MerchantReturnRequest.
        :type: float
        """
    ...
    def refund_excl_vat(self):
        """
        Gets the refund_excl_vat of this MerchantReturnRequest.

        :return: The refund_excl_vat of this MerchantReturnRequest.
        :rtype: float
        """
    ...
    def refund_excl_vat(self, refund_excl_vat):
        ...
        :param refund_excl_vat: The refund_excl_vat of this MerchantReturnRequest.
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, MerchantReturnRequest):
            return False
